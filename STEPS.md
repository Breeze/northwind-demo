...
4. Create the client ([Angular 22](client/STEPS-Client-Angular22.md), [Angular 8](client/STEPS-Client-Angular8.md), [Aurelia](client/STEPS-Client-Aurelia.md), [React](client/STEPS-Client-React.md), or [Vue](client/STEPS-Client-Vue.md))
...
- [STEPS-Client-Angular22](client/STEPS-Client-Angular22.md) for an Angular 22 app,
- [STEPS-Client-Angular8](client/STEPS-Client-Angular8.md) for an Angular 8 app,
